...
class GameLogoScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        snakeLabel.position = CGPoint(x: (frame.midX + 75), y: frame.midY + 50)
        self.addChild(snakeLabel)
        
        snakeImage.position = CGPoint(x: (frame.midX + 100), y: frame.midY - 75)
...
class MainGameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        topBorder.position = CGPoint(x: frame.minX + 285, y: frame.maxY - 80)
        topBorder.name = "top border"
        topBorder.zPosition = 2.0
        self.addChild(topBorder)
        topBorder.setScale(0.15)
        
        leftBorder.position = CGPoint(x: frame.minX + 100, y: frame.midY)
        leftBorder.name = "left border"
        leftBorder.zPosition = 3.0
        self.addChild(leftBorder)
        leftBorder.setScale(0.75)
        
        bottomBorder.position = CGPoint(x: frame.minX + 285, y: frame.minY + 80)
        bottomBorder.name = "bottom border"
        bottomBorder.zPosition = 4.0
        self.addChild(bottomBorder)
        bottomBorder.setScale(0.75)
        
        rightBorder.position = CGPoint(x: frame.minX + 400, y: frame.midY)
        rightBorder.name = "right border"
        rightBorder.zPosition = 5.0
        self.addChild(rightBorder)
        rightBorder.setScale(0.75)
